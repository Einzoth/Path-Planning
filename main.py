...
def run_maze():
	...
	for episode in range(2000):
		...
		while True:
			...
			env.store_data(state_current0, action0, reward, state_new0)
			env.store_data(state_current1, action1, reward, state_new1)
			env.store_data(state_current2, action2, reward, state_new2)
			env.store_data(state_current3, action3, reward, state_new3)
			# print(observation_)
